...
<Frame>
  <img src="/images/ListenBrainsExample.webp" alt="Example of ListenBrainz music tile on OshiSocial profile" style={{display: 'block', margin: '0 auto'}} />
</Frame>
...
<Steps>
  <Step title="Create Your ListenBrainz Account">
    ...
    <Frame>
      <img src="/images/ListenBrainsCreateAccount1.webp" alt="ListenBrainz signup page" style={{display: 'block', margin: '0 auto'}} />
    </Frame>
  ...
  <Step title="Connect to OshiSocial">
    ...
    <Frame>
      <img src="/images/ListenBrainsCreateLinkAccount.webp" alt="OshiSocial profile settings page" style={{display: 'block', margin: '0 auto'}} />
    </Frame>
  ...
  <TabItem label="Spotify">
    ...
    <Steps>
      <Step title="Open Music Service Settings">
        ...
        <Frame>
          <img src="/images/ListenBrainsCreateAccount2.webp" alt="ListenBrainz Spotify connection page" style={{display: 'block', margin: '0 auto'}} />
        </Frame>
      </Step>
